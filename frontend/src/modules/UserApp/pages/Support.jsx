...
import { FiPlus, FiChevronRight, FiAlertCircle, FiSend, FiArrowLeft, FiPhone, FiMail, FiTag, FiCopy } from 'react-icons/fi';
...
const Support = () => {
    ...
    useEffect(() => {
        ...
        const handleNewSupportMessage = (msg) => {
            ...
            if (selectedTicket && selectedTicket._id === ticketId) {
                ...
                toast.success(`New message on Ticket #${ticketId.slice(-6).toUpperCase()} from ${senderName}: "${normalizedMsg.message}"`);
            }
        };
    ...
    const handleSendReply = async (e) => {
        ...
        setIsSending(true);
        try {
            const res = await supportService.addTicketMessage(selectedTicket._id, trimmedReply);
            ...
            setSelectedTicket(prev => {
                ...
                if (exists) return prev;
                const sorted = [...messages, normalizedNewMsg].sort((a, b) => new Date(a.createdAt) - new Date(b.createdAt));
                return {
                    ...prev,
                    messages: sorted
                };
            ...
            elements.push(
                <div key={idx} className={`flex ${msg.senderType === 'user' ? 'justify-end' : 'justify-start'}`}>
                    ...
                    >
                        ...
                        <p className={`text-[9px] mt-1 text-right ${msg.senderType === 'user' ? 'text-blue-200' : 'text-gray-400'}`}>
    ...
    return (
        <PageTransition>
            <MobileLayout showBottomNav={!selectedTicket} showCartBar={!selectedTicket}>
                        ...
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                            ...
                            <div className="min-w-0 flex-1">
                                <h1 className="text-lg font-bold text-gray-800 truncate leading-tight">
                                    {selectedTicket ? selectedTicket.subject : isCreating ? 'Create New Ticket' : 'Contact Us'}
                                </h1>
                                {selectedTicket && (
                    ...
                    <div className={selectedTicket ? "max-w-3xl mx-auto p-0 sm:p-4" : "max-w-3xl mx-auto p-4"}>
                        {isCreating ? (
                            ...
                            <div className="space-y-4 pt-4">
                                ...
                                <div className="space-y-3">
                                    {isLoading ? (
                                        ...
                                        tickets.map(ticket => (
                                            <div 
                                                ...
                                                onClick={() => {
                                                    ...
                                                    sessionStorage.setItem('active_ticket_id', ticket._id);
                                                }}
                                        ...
                                        <div className="bg-white rounded-2xl p-10 text-center border border-gray-100">
                                            ...
                                            <p className="text-gray-700 font-bold">No support tickets found.</p>
                                ...
                                <h2 className="text-lg font-bold text-gray-800 mt-8 mb-4 px-2">Get in Touch</h2>
