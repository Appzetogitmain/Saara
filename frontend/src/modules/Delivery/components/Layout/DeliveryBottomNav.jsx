...
const DeliveryBottomNav = () => {
  ...
  const navContent = (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-l border-r border-accent-200/30 z-[9999] safe-area-bottom shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
